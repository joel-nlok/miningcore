...
namespace Miningcore.Tests.Persistence.Postgres.Repositories
{
    public class BalanceRepository : IBalanceRepository
    {
        ...
        public Task<BalanceChange[]> GetBalanceChangesByTagAsync(IDbConnection con, IDbTransaction tx, string poolId, string tag)
        {
            throw new NotImplementedException();
        }
        ...
        Task<decimal> IBalanceRepository.GetBalanceAsync(IDbConnection con, string poolId, string address)
        {
            throw new NotImplementedException();
        }
    }
